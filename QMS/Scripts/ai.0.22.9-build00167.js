        ...
        (function (Context) {
            ...
            var _SessionManager = (function () {
                function _SessionManager(config) {
                    ...
                    if (!(typeof config.sessionExpiratioQMS === "function")) {
                        config.sessionExpiratioQMS = function () { return _SessionManager.acquisitionSpan; };
                    }
                ...
                _SessionManager.prototype.update = function () {
                    ...
                    var now = +new Date;
                    var acquisitionExpired = now - this.automaticSession.acquisitionDate > this.config.sessionExpiratioQMS();
                ...
                _SessionManager.prototype.setCookie = function (guid, acq, renewal) {
                    var acquisitionExpiry = acq + this.config.sessionExpiratioQMS();
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var PageView = (function (_super) {
                ...
                function PageView(name, url, duratioQMS, properties, measurements) {
                    _super.call(this);
                    this.aiDataContract = {
                        ver: ApplicationInsights.FieldType.Required,
                    ...
                    if (!isNaN(duratioQMS)) {
                        this.duration = ApplicationInsights.Util.msToTimeSpan(duratioQMS);
                    }
                    this.properties = ApplicationInsights.Telemetry.Common.DataSanitizer.sanitizeProperties(properties);
                    this.measurements = ApplicationInsights.Telemetry.Common.DataSanitizer.sanitizeMeasurements(measurements);
                }
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var PageViewPerformance = (function (_super) {
                ...
                PageViewPerformance.prototype.getDuratioQMS = function () {
                    return this.duratioQMS;
                };
                        ...
                        try {
                            if (Telemetry.PageViewPerformance.isPerformanceTimingDataReady()) {
                                ...
                                if (!pageViewPerformance.getIsValid() && !pageViewSent) {
                                    ...
                                    if (!pageViewSent) {
                                        _this.appInsights.sendPageViewInternal(name, url, pageViewPerformance.getDuratioQMS(), properties, measurements);
                                    }
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    sessionExpiratioQMS: function () { return _this.config.sessionExpiratioQMS; },
    ...
    (function (ApplicationInsights) {
        ...
        var Initialization = (function () {
            ...
            Initialization.getDefaultConfig = function (config) {
                ...
                config.sessionExpiratioQMS = 24 * 60 * 60 * 1000;
